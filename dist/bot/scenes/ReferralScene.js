...
export const referralScene = new Scenes.BaseScene(SCENES.REFERRAL);
...
referralScene.enter(async (ctx) => {
    ...
    const text = Messages.referralInfo(ctx.user, referralCount, totalCommission, COMMISSION_RATE);
