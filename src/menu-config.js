...
export const ICON_GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { key: "SOCIAL_PROOF_RENEW", label: "Gia hạn · Tiêu đề", icon: "🔄" },
            { key: "BC_RENEW_SPEC", label: "Gia hạn · Dòng token / ngày cộng thêm", icon: "➕" },
            { key: "BC_RENEW_TOTAL", label: "Gia hạn · Dòng quota còn lại", icon: "🎁" },
