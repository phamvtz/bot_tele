    ...
    <div>
      <div className="flex items-center justify-between mb-1">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 text-gray-500 border border-gray-200 rounded-lg text-sm hover:bg-gray-50 transition-colors"
        >
          <RefreshCw size={13} />
          Làm mới
        </button>
                ...
                return (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <p className="text-[10px] text-gray-400 mt-0.5">{formatCurrency(p.price)}</p>
                    </div>
                    <span
          ...
          {!selected ? (
            <div className="flex flex-col items-center justify-center h-full text-gray-300">
              <div className="w-14 h-14 rounded-2xl bg-gray-50 flex items-center justify-center mb-3">
                <Layers size={26} strokeWidth={1.5} className="text-gray-300" />
              </div>
              <p className="text-sm text-gray-400 font-medium">Chọn sản phẩm để quản lý kho</p>
            </div>
          ) : (
            <>
              {/* Header */}
              ...
              <div className="px-5 py-4 border-b border-gray-100 bg-gray-50/50">
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-xs font-mono bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/30 resize-none"
                />
                <div className="flex items-center gap-2 mt-2">
                  <button
                    onClick={() => bulkMut.mutate()}
                    disabled={!lines.trim() || bulkMut.isPending}
                    className="px-4 py-1.5 bg-primary-500 text-white rounded-lg text-xs font-semibold hover:bg-primary-600 disabled:opacity-50 transition-colors"
                  >
              ...
              <div className="flex items-center gap-0.5 px-5 py-2 border-b border-gray-100">
                <button
                  ...
                  className={`px-3 py-1.5 text-xs rounded-lg font-medium transition-colors ${
                    !showSold ? "bg-primary-500 text-white" : "text-gray-500 hover:bg-gray-100"
                  }`}
                >
              ...
              <div className="flex-1 overflow-y-auto px-5 py-3">
                {stockLoading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-10">
                    <Archive size={28} strokeWidth={1.5} className="text-gray-200 mb-2" />
